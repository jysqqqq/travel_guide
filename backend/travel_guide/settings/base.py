...
INSTALLED_APPS = [
    ...
    # 添加 REST framework 和 CORS
    "rest_framework",
    "corsheaders",
]

MIDDLEWARE = [
    # 添加 CORS 中间件，注意要放在最前面
...
WAGTAIL_SITE_NAME = "travel_guide"
...
SIMPLE_JWT = {
    ...
    'ALGORITHM': 'HS256',
    'SIGNING_KEY': 'django-insecure-)$2r)^n=l6@a@0-n_bq76pj30xhz3=g4+q(i+h5(v9h1r91wcv',
    'VERIFYING_KEY': None,
    'AUDIENCE': None,
    'ISSUER': None,
...
# 设置CSRF豁免
CSRF_COOKIE_SECURE = False  # 开发环境使用HTTP
CSRF_COOKIE_HTTPONLY = False  # 允许JavaScript访问cookie
CSRF_USE_SESSIONS = False  # 不使用session
CSRF_COOKIE_SAMESITE = 'Lax'  # 允许跨站请求

# 高德地图API配置
AMAP_API_KEY = '421fb6b7f66308b350e986904a2a8724'  # 请替换为您的实际API密钥
